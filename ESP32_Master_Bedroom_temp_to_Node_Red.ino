...
const char* mqttClientID = "ESP32ClientMasterBed";
WiFiClient espClientMasterBed;//**********This is the name of the specific ESP32**********
PubSubClient client(espClientMasterBed);//**********This is the name of the specific ESP32**********
const char* topicPrefix = "apt/masterBed";//This is specifically for "Topic Prefix/xxxxx
const char* topicRoom = "masterBed";
